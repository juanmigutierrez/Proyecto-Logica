...
# Regla 1: Debe haber exactamente cuatro reinas en el tablero
...
#Prueba = T.StringtoTree('02-03-04-05-06-09-111316010708121415YYYYYYYYYYYYYY01>', letrasProposicionales)
#print ("Formula: ", T.Inorder(A1))
